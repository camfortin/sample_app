...
def random
  person = ["Cam", "Cary", "Dad", "Mom", "Robin", "Zack", "Judy", "Rick"].sample
  parents = ["loves you", "wants to tickle you","wishes you would sleep through the night", "thinks you can be anything you want to be when you grow up", "can't wait until you are potty trained", "will scratch your back when you are sick", "can't wait to pay for college"].sample
